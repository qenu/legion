...
CONTENT_STATUS_ALIASES = {
    "enable": ContentStatus.ENABLED, "enabled": ContentStatus.ENABLED,
    "disable": ContentStatus.DISABLED, "disabled": ContentStatus.DISABLED,
    "remove": ContentStatus.REMOVED, "removed": ContentStatus.REMOVED,
}
