...
LEGION_NOT_CONFIGURED = (
    "兵團尚未成立，需要一位管理員先運行設置並選擇一個頻道。"
)
LEGION_UPGRADE_READY = (
    "**{legion}** 已經完成升級至等級 {level} 的條件！"
)
...
INVENTORY_DISMANTLE_CONFIRM = "確定要拆解 **{weapon}** 嗎？此操作無法復原，回收材料並非必定。"
...
FOOD_BUFF_APPLIED = "食用了 **{material}**，每分鐘恢復 {value:,} 點生命值，持續 {duration} 分鐘。"
FOOD_BUFF_EFFECT = "增加 {value:,} {category} ，持續 {duration} 分鐘"
FOOD_BUFF_EFFECT_APPLIED = "食用了 **{material}**，增加 {value:,} {category} ，持續 {duration} 分鐘。"
...
INVENTORY_USED_OTHER = "對 **{target}** 使用了 **{material}**，恢復 {healed:,} 點生命值。"
REVIVED_OTHER = "**{material}** 將 **{target}** 從鬼門關拉了回來，恢復 {healed:,} 點生命值！"
...
MATERIAL_KIND_NAMES = {
    "material": "材料", "food": "食物", "potion": "藥水",
    "consumable": "消耗品", "chest": "寶箱",
}
...
PATCH_FORCE_CONFIRM = (
    "⚠️ 強制更新將 **立即生效**，跳過鎖定時間。正在進行中的玩家將不會收到警告。是否繼續？"
)
PATCH_CURRENT = "目前版本"
PATCH_NOTES = "更新內容"
...
# --- emoji ---
BATTLE_EMOJI = "<:battle:1526073250751189143>"
UP_EMOJI = "<:arrow_up:1526073257495629976>"
CHECK_EMOJI = "<:greenTick:1408101518074187786>"
CROSS_EMOJI = "<:redTick:1408101524118306996>"
ARROW_LEFT_EMOJI = "<:arrow_back:1526073263200010360>"
ARROW_RIGHT_EMOJI = "<:arrow_front:1526073261480480808>"
SKULL_EMOJI = "<:skull:1526073253746184282>"
LOCK_EMOJI = "<:lock:1526073248754831390>"
COG_EMOJI = "<:cogwheel:1526073259387519077>"
